...
var QQfaceString = map[int]string{
	0:   "😮", // 😮 face exhaling
	1:   "😬", // 😬 grimacing face
	...
	11:  "😡", // 😡 pouting face
	12:  "😛", // 😛 face with tongue
	13:  "😁", // 😁 beaming face with smiling eyes
	14:  "🙂", // 🙂 slightly smiling face
	15:  "🙁", // 🙁 slightly frowning face
	16:  "😎", // 😎 smiling face with sunglasses
	19:  "🤮", // 🤮 face vomiting throw
	20:  "🤭", // 🤭 face with hand over mouth embarrassed
	21:  "😊", // 😊 smiling face with smiling eyes
	23:  "😕", // 😕 confused face
	24:  "😋", // 😋 face savoring food
	27:  "😓", // 😓 downcast face with sweat
	28:  "😄", // 😄 grinning face with smiling eyes
	31:  "🤬", // 🤬 face with symbols on mouth
	32:  "🤔", // 🤔 thinking face question hmmm
	33:  "🤫", // 🤫 shushing face quiet whisper
	34:  "😵", // 😵 face with crossed-out eyes
	35:  "😣", // 😣 persevering face
	37:  "💀", // 💀 skull
	46:  "🐷", // 🐷 pig face
	53:  "🎂", // 🎂 birthday cake
	59:  "💩", // 💩 pile of poo
	60:  "☕", // ☕ hot beverage coffee cup tea
	63:  "🌹", // 🌹 rose flower
	66:  "❤", // ❤ mending heart
	67:  "💔", // 💔 broken heart
	69:  "🎁", // 🎁 wrapped-gift
	74:  "🌞", // 🌞 sun with face
	75:  "🌜", // 🌜 last quarter moon face
	96:  "😅", // 😅 grinning face with sweat
	104: "🥱", // 🥱 yawning face
	109: "😗", // 😗 kissing face
	110: "😲", // 😲 astonished face
	111: "🥺", // 🥺 pleading face
	172: "😛", // 😛 face with tongue
	182: "😂", // 😂 face with tears of joy
	187: "👻", // 👻 ghost
	247: "😷", // 😷 face with medical mask
	272: "🙃", // 🙃 upside-down face
	320: "🥳", // 🥳 partying face
	325: "😱", // 😱 face screaming in fear
}

// var qqface = map[int]int64{
